    ...
    <Layout>
      ...
      <div className="one-times">
        ...
        <div className="switch">
          <div className="switch-left">One-Time Customised Investment Plan</div>
          ...
          <div className="container">
            <AnimatedWrapper>
              <p>
                ...
                investment planning to offer a more comprehensive financial
                plan. We define your financial objectives, duration, and risk
                tolerance, taking into account other prevailing circumstances
                such as estate planning, insurance needs, and retirement goals.
                A comprehensive financial plan serves as a foundational guide,
                followed by not just portfolio construction but also debt
                management, retirement planning, and estate planning. During our
                maximum of four (4) meetings (via phone, video, or in-person at
                our office), we collaboratively create a customized financial
                plan designed for you to implement independently.{" "}
