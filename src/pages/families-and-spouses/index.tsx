              ...
              <div className="row">
                <div className="col-12 col-md-7 col-left">
                  <p>
                    ...
                    that's why WealthHat is here to assist families and spouses
                    in managing their financial journey. Families often have
                    unique circumstances, and we're well-equipped to address
                  ...
                  <div className="mb-3">
                    ...
                    <p>
                      ...
                      that go beyond the ordinary. They seek strategies that
                      help grow and safeguard their wealth while optimizing tax
                      efficiency. Managing a diverse financial portfolio
                      requires attention to detail, addressing complexities that
                      are unique to their situation. Families may also require
                      guidance on succession planning, wealth transfer, and
                      ensuring financial security for spouses and future
                      generations.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-12 col-md-5 col-right">
                  <div>
                    ...
                    <p>
                      ...
                      experts with diverse backgrounds, including capital
                      markets, investment banking, portfolio management, wealth
                      structuring, and family office management. We blend
                      institutional resources with personalized service to
                      provide solutions that align with the unique needs of
                    ...
                    <p>
                      ...
                      designed to address the specific needs of your family and
                      spouse. Your family's financial well-being is our top
