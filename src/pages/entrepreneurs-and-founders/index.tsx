              ...
              <div className="row">
                <div className="col-12 col-md-7 col-left">
                  <p>
                    ...
                    founders who have not only built their wealth but also
                    created thriving businesses. We specialize in providing
                    tailored financial solutions that address the distinct
                    circumstances and challenges faced by these visionary
                    leaders.
                  </p>
                  ...
                  <div className="mb-3">
                    ...
                    <p>
                      ...
                      that includes concentrated public company positions,
                      private investment companies, family foundations, and
                      family offices. Their enterprises often expand across
                      borders, introducing complexities related to taxation,
                      legal requirements, and regulatory compliance. The
                      ever-evolving landscape of investment trends, evolving
                      operational practices, and family dynamics further
                      contribute to the intricacy of their financial situation.
                    </p>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <p>
                      Entrepreneurs and founders require financial strategies
                      that not only preserve their wealth but also fuel its
                      growth. They seek solutions that are tailored to their
                      unique circumstances, encompassing tax optimization,
                      business succession planning, and the management of
                      intricate financial portfolios. Additionally, they may
                      need guidance on scaling their businesses, diversifying
                      investments, and planning for wealth transfer to the next
                      generation.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-12 col-md-5 col-right">
                  <div>
                    ...
                    <p>
                      ...
                      investment opportunities, succession planning guidance,
                      and expert advice on managing complex financial
                      portfolios. Our institutional-level analytics, actionable
                      strategies, and best practices ensure the prudent
                      management of both personal and business assets.
                    </p>
